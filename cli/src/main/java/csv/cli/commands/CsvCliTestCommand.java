 ...
 */
package csv.cli.commands;

import org.apache.karaf.shell.commands.Command;
import org.apache.karaf.shell.commands.Option;
import org.apache.karaf.shell.console.AbstractAction;
import csv.cli.api.CsvCliCommands;
...
public class CsvCliTestCommand extends AbstractAction {

    private static final Logger LOG = LoggerFactory.getLogger(CsvCliTestCommand.class);
    protected final CsvCliCommands service;

    public CsvCliTestCommand(final CsvCliCommands service) {
